...
public class fxClient {
    ...
    public fxClient(Client c) {
        switch (c.getType()) {
        case CIRCLE:
            shape = getLittleCircle();
            break;
        case SQUARE:
            shape = getLittleSquare();
            break;
        case TRIANGLE:
            shape = getLittleTriangle();
            break;
        case STAR:
            shape = getLittleStar();
            break;
        case CROSS:
            shape = getLittleCross();
            break;
        case SECTOR:
            shape = getLittleSector();
            break;
        case DIAMOND:
            shape = getLittleDiamond();
            break;
        case PENTAGON:
            shape = getLittlePentagon();
            break;
        default:
            shape = null;
        }
