...
public class Controller implements Initializable {
    ...
    public void setRound(int round, Group g) {
        ...
        if (round == 2) {
            ...
            game = new Game(gameView, 3, 1, 3, 4, 0);
        } else if (round == 9) {
            game = new Game(gameView, 4, 2, 3, 6, 0);
        }
