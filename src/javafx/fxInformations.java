...
public class fxInformations extends Group {
    ...
    public fxInformations(double posX, double posY, String train, String wagon, String line, String tunnel,
        ...
        imageTunnel = new ImageView(
                new Image(this.getClass().getResource("/img/tunnel.png").toString(), 40, 40, false, false));
        imageTrain = new ImageView(
                new Image(this.getClass().getResource("/img/train.png").toString(), 40, 40, false, false));
        imageWagon = new ImageView(
                new Image(this.getClass().getResource("/img/wagon.png").toString(), 40, 40, false, false));
        imageLine = new ImageView(
                new Image(this.getClass().getResource("/img/rails.png").toString(), 40, 40, false, false));
        imageStation = new ImageView(
                new Image(this.getClass().getResource("/img/station.png").toString(), 40, 40, false, false));
