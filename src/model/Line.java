...
public class Line {
    ...
    public boolean addAllowed(Station s) {
        boolean allowed = stationList.indexOf(s) != -1 && stationList.indexOf(s) != 0
    ...
    public void addStationFromLink(int index, Station station, double middleX, double middleY, double middleX2,
            double middleY2) {
        stationList.add(index, station);
