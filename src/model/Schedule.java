...
public class Schedule {
	...
	public Schedule(int type, Group g, GameView gv, Game game1) {
		...
		if (type == 0) {
			...
			events.add(new Event(15000, ShapeType.CROSS, new Position(770, 140)));
...
//			events.add(new Event(40000, ShapeType.TRIANGLE, new Position(810, 250)));
			...
			// 第二阶段第一回合
			events.add(new Event(0, ShapeType.SQUARE, new Position(690, 85)));
			...
			events.add(new Event(0, ShapeType.CIRCLE, new Position(350, 235)));
			events.add(new Event(0, ShapeType.CIRCLE, new Position(480, 240)));
			...
			events.add(new Event(0, ShapeType.CIRCLE, new Position(280, 160)));
...
//			borderRiver.setStrokeLineJoin(StrokeLineJoin.ROUND);
			...
			btn1.setOnMouseClicked(new EventHandler<MouseEvent>() {
				@Override
				public void handle(MouseEvent event) {
					Platform.runLater(()->Main.proceed(10));
				}
			});
	...
	public class JavaApp {
		...
		public void submitAnswer(int answer) {
			...
			Platform.runLater(()->Main.proceed(2));
			DbConnector.updateG("g1", Integer.toString(answer));
		}
	}
