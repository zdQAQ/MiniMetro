...
//        }
    ...
    public void move() {
        ...
        if (nextPointIndex != line.getPath().size() - 1 && nextPointIndex % 2 == 0) {
            if (direction && angle(line.getPath().get(nextPointIndex), line.getPath().get(nextPointIndex + 1)) == angle(
                    line.getPath().get(nextPointIndex + 1), line.getPath().get(nextPointIndex + 2))) {
                ++nextPointIndex;
                verif();
            }
        }
        if (nextPointIndex != 0 && nextPointIndex % 2 == 0) {
            if (!direction
                    && angle(line.getPath().get(nextPointIndex), line.getPath().get(nextPointIndex - 1)) == angle(
                            line.getPath().get(nextPointIndex - 1), line.getPath().get(nextPointIndex - 2))) {
                --nextPointIndex;
                verif();
            }
